...
function helix_tinymce_adjustments() {
   ...
   if ( get_user_option('rich_editing') == 'true' ) {
     add_filter('mce_external_plugins', 'helix_tinymce_plugins');
		 add_filter('mce_buttons_2', 'helix_tinymce_buttons_toolbar2', 2);
   }
	 
}
add_action('admin_head', 'helix_tinymce_adjustments');


// Add buttons in second row
function helix_tinymce_buttons_toolbar2($buttons) {
	$buttons[] = 'helix';
